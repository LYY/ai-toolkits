You are evaluating the address-pr-comments-review skill. Read the SKILL.md and its reference files under skills/address-pr-comments-review/. Then, acting as if generating a Review Dossier for a PR with complex code change comments, return ONLY a JSON object with this exact schema:
