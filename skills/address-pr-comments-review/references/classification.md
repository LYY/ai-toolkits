...
### Stale Metadata Is Not Evidence

No stale-context metadata field -- `thread_outdated`, `thread_resolved`, or any other GitHub UI signal -- is ever sufficient as standalone evidence of fix-state. All such fields require code verification at the actual `path:line` on current HEAD before they can inform a conclusion. This is a hard rule with no exceptions.
