#!/usr/bin/env python3
# FROZEN HISTORICAL SNAPSHOT — This file is archived and no longer maintained.
# The active version lives at: skills/address-pr-comments-review/scripts/list_comments.py
# Do not edit this file. Make changes to the active version only.
# Vendored copy (archived) — kept for reference only
"""
