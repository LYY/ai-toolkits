...
| [address-pr-comments-review](./skills/address-pr-comments-review/) | 交互式 PR review 处理 — 收集、分类、人工确认、生成 review dossier，再通过 Prometheus 交互生成执行计划，`/start-work` 执行。适合复杂 PR 或需要人工决策的场景 |
